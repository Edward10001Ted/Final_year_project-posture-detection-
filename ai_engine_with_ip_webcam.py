...
from sena_status import publish_status, start_background_publisher
...
def run_ai_webcam_loop():
    ...
    # Use your IP webcam stream instead of the laptop camera
...
# Run Pose Detection
            ...
            publish_status(LIVE_OUTPUT_STREAM)
...
ai_thread.start()
start_background_publisher(interval_seconds=60.0, getter=lambda: LIVE_OUTPUT_STREAM)
